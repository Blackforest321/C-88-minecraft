...
function my_keydown(e)
    {
        ...
        {
            console.log("The p and shift key are pressed together.");
        ...
        {
            console.log("The m and shift key are pressed together.");
            block_width= block_width-10;
            block_height= block_height-10;
            document.getElementById("current_width").innerHTML=block_width;
            document.getElementById("current_height").innerHTML=block_height;
...
function up()
{
    if(player_y>=0)
    {
        ...
        console.log("blockimage heightis:"+ block_height);
...
function down()
{
    if(player_y<=460)
    {
        ...
        console.log("when down arrow ispressed,x="+player_x+"y="+player_y);
        canvas.remove(player_obj);
        player_update();
...
function right()
{
    if(player_x<=860)
    {
        ...
        console.log("block height"+ block_height);
        console.log("when right arrow ispressed,x="+player_x+"y="+player_y);
        canvas.remove(player_obj);
        player_update();
...
function left()
{
    if(player_x>=0)
    {
        player_x=player_x-block_height;
        console.log("block height"+ block_height);
        console.log("when left arrow ispressed,x="+player_x+"y="+player_y);
        canvas.remove(player_obj);
        player_update();
